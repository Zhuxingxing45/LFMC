...
for example in tqdm(raw_dataset):
    ...
    data = {
                "conversation": [
                    {
                        "system":"You are a logician. Please select the correct answer from the options based on the given context and question, and provide the reasoning process.",
                        "input": prompt,
...
with open('FOLIO_fintuing_data_formatted_v1.json', 'w', encoding = 'utf-8') as f:
