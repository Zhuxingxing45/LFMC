...
parser.add_argument("--model_path", type=str,default='root/internlm2/7b/internlm2_logic_origin/internlm2_logic_original_hf_merged',  help="Path to model")
parser.add_argument("--output_path", type=str, default="/internlm2/7b/origin", help="Output JSON file")
parser.add_argument("--result_path", type=str, default="/internlm2/7b/origin.json", help="Result JSON file")
        ...
        with open(file_path, 'r') as f:
            for i, line in enumerate(tqdm(f, desc="Processing FOLIO")):
                ...
                prompt = (
                    ...
                    # 'Please only give the final answer (A/B/C), do not include any reasoning.'
        ...
        with open(file_path, 'r') as f:
            for i, line in enumerate(tqdm(f, desc="Processing LogiQA_v2")):
                ...
                prompt = (
                    ...
                    # 'Please only give the final answer (A/B), do not include any reasoning.'
                    "Please provide the correct option.\nAnswer and reasoning step by step:"
                )
                messages = [
