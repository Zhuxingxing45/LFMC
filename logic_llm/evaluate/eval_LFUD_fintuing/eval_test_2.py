...
def main():
    # 数据集路径  
    file_path = '/home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/logic_llm/results/logic_LFUD_fintue'
    dataset_names = {
    ...
    # 记录评估结果
    results_file_path = '/home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/logic_llm/evaluate/outputs/logic_LFUD_fintue_evaluation_results.json'
