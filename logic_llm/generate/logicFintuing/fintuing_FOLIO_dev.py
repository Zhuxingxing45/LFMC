...
model_path = '/home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/root/llama3_logic_base/llama3_logic_original_hf_merged'
...
with open("/home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/data/FOLIO/folio_v2_validation_203.jsonl", 'r') as f:
    for line in f:
        ...
        if idx % 50 == 0:
            with open ("/home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/logic_llm/results/logic_origin_fintue/FOLIO_fintuing_dev.json", 'w') as ft:
                json.dump(processed_data, ft, ensure_ascii=False, indent=4)
                print(f"{len(processed_data)} new data have been generated.\n")
            
            # with open ("/home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/logic_llm/results/FOLIO_fintuing_dev.json", 'w') as ft:
            #     json.dump(processed_data, ft, ensure_ascii=False, indent=4)
            #     print(f"{len(processed_data)} new data have been generated.\n")
