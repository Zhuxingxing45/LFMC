...
model_path = 'root/llama3_logic_correct_ez/llama3_logic_original_hf_merged'
...
with open("data/FOLIO/folio_v2_validation_203.jsonl", 'r') as f:
    for line in f:
        ...
        if idx % 50 == 0:
            with open ("logic_llm/results/logic_correct_fintue_ez_v10/FOLIO_fintuing_dev.json", 'w') as ft:
