# # 运行第一个 Python 文件
python /home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/logic_llm/reasoning_colloction/basemodel/Reclor_train_data.py

# 检查上一个命令是否成功执行
if [ $? -ne 0 ]; then
    echo "basemodel/Reclor_train_data.py 执行失败"
    exit 1
fi
