...
processed_data = []
idx = 0
with open("/home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/data/LogiQA_v2/train_6.87k.jsonl", 'r' ) as f:
    for line in f:
        ...
        if idx % 50 == 0:
            with open ("/home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/logic_llm/reasoning_colloction/output/logicotFintuing/LogiQA_v2_reasoning_path.json", 'w') as ft:
