...
processed_data = []
idx = 4900
with open("/home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/data/logiqa-zh/zh_train.json", 'r') as f:
    dataset = json.load(f)
    for example in tqdm(dataset[4900:]):
        ...
        if idx % 10 == 0:
            ...
            with open ("/home/23_zxx/workspace/llama3-ft/Llama3-Tutorial/logic_llm/reasoning_colloction/output/logicotFintuing/logiqa-zh_reasoning_path.json", 'w') as ft:
